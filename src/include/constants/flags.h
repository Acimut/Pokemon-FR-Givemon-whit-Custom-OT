...
#include "trainers.h" //#include "constants/trainers.h"
...
#define FLAG_0x837                                                  (SYS_FLAGS + 0x37)  //FLAG_SYS_RESET_RTC_ENABLE
...
#define FLAG_0x83F                                                  (SYS_FLAGS + 0x3F)  //FLAG_SYS_CLOCK_SET
