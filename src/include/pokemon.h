...
struct BattleMove
{
    ...
    s8 priority;
    u8 flags;
    u8 relleno_1;//byte de relleno para que coincida el byte de pss en g3t
    u8 category;//PSS
    u8 relleno_3;//bytes de rellenos para completar el tamaño de la estructura = 0xC bytes
};
